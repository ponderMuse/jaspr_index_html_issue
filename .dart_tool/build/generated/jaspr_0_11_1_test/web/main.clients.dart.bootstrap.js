...
define("main.clients.dart.bootstrap", ["web/main.clients", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__main$46clients || app.main$46clients).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "main.clients.dart") {
          // Clear static caches.
