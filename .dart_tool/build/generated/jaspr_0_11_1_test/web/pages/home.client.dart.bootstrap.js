...
let modulePaths = {
 ...
 "packages/binary_codec/binary_codec": "packages/binary_codec/binary_codec.ddc",
 "packages/jaspr/browser": "packages/jaspr/browser.ddc",
 "packages/jaspr/src/foundation/annotations": "packages/jaspr/src/foundation/annotations.ddc",
 "packages/jaspr_0_11_1_test/app": "packages/jaspr_0_11_1_test/app.ddc",
 "packages/jaspr_0_11_1_test/pages/about": "packages/jaspr_0_11_1_test/pages/about.ddc",
 ...
 "web/pages/home.client": "pages/home.client.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'home.client.digests',
...
define("home.client.dart.bootstrap", ["web/pages/home.client", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__pages__home$46client || app.home$46client).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "pages/home.client.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("home.client.dart.bootstrap", {
    "home.client.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
