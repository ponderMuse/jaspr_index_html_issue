...
let modulePaths = {
 ...
 "web/pages/about.client": "pages/about.client.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'about.client.digests',
...
define("about.client.dart.bootstrap", ["web/pages/about.client", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__pages__about$46client || app.about$46client).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "pages/about.client.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("about.client.dart.bootstrap", {
    "about.client.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
